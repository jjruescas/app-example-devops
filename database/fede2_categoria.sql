...
CREATE TABLE `categoria` (
  ...
  `categoria_nombre` varchar(200) DEFAULT 'categoria' COMMENT 'TEXT',
  PRIMARY KEY (`id_categoria`),
  UNIQUE KEY `categoria_nombre_UNIQUE` (`categoria_nombre`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='pelicula';
...
INSERT INTO `categoria` VALUES (2,'Comedia'),(5,'Drama');
